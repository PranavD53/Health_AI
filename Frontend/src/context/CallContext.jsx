...
export function CallProvider({ children }) {
  ...
  const setupWebRTCConnection = async (callInfo) => {
    ...
    // 1. Acquire media stream FIRST, before creating PC and exposing it to incoming signals
    // This prevents incoming SDP offers from being processed with recvonly when our tracks aren't added yet
